function scr_OLDTVFilter_Setup() //gml_Script_scr_OLDTVFilter_Setup
{
    application_surface_draw_enable(false)
    global._oldtv_timer = 0
    ...
    global._composite_kernel_flag = 0
    global._composite_kernel_positive[0] = -1
    global._composite_kernel_positive[1] = 2
    global._composite_kernel_positive[2] = -1
    global._composite_kernel_negative[0] = 1
    global._composite_kernel_negative[1] = -2
    global._composite_kernel_negative[2] = 1
