...
if (global.dark == 0)
{
    ...
    draw_set_font(fnt_1)
    draw_text((x - 50), (y - 250), "Press [Spacebar]")
}
if (global.dark == 1)
{
    if (text == 1)
    {
        ...
        draw_set_color(c_white)
        draw_set_font(fnt_1)
        draw_text((x - 50), (y + 60), "please leave while you still can")
    }
    if (text == 2)
    {
        draw_set_color(c_white)
        draw_set_font(fnt_1)
        draw_text((x - 50), (y + 60), "you don't want to end up like them")
    }
    if (text == 3)
    {
        draw_set_color(c_red)
        draw_set_font(fnt_1)
        draw_text((x - 50), (y + 60), "kovzhv orhgvm gl nv, blf wlm'g dzmg gsrh uzgv")
    }
    if (text == 4)
    {
